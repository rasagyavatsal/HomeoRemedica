...
Current non-public versions of `dataset/`, generated corpus databases, manifests, and other derived
corpus artifacts are restricted internal assets. They are not licensed for public distribution.
...
use or redistribution, verify the provenance, edition, jurisdictional copyright status, and source
terms for every included work.

Do not copy corpus assets, source-derived excerpts used as fixtures, or build outputs into this
public repository. Public tests must use small synthetic data created specifically for that purpose.
